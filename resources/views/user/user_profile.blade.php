...
<div class="container mb-4" style="border-bottom: .5px solid gray;">
    ...
    <div class="row">
      <div class="col-sm-8">
        <form method="POST" action="{{ route('update_details', ['id' => $data->id]) }}">
          @csrf
            <div class="form-floating mb-3 mt-4">
              ...
              <div class="form-floating mb-3 mt-4">
                <input type="text" class="form-control" id="floatingInput" name="phone" value="">
  ...
  <div class="container mb-4" style="border-bottom: .5px solid gray; ">
    ...
    <div class="row">
      <div class="col-sm-8">
        <form method="POST" action="{{ route('update_password', ['id' => $data->id]) }}">
          @csrf
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-8">
        <form action="{{ route('delete_account', ['id' => $data->id]) }}" method="POST">
          @csrf
          <div class="form-floating mb-3">
            <input type="password" class="form-control" name="password" id="floatingInput" placeholder="Password">
